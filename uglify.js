! function (e, t) {
  ...
  function g(e, t, n, o, i) {
    ...
    return e || (e = {
      items: []
    }), e.items.push(t), e.timeout || (i && r(e.items), e.timeout = setTimeout(r, n)), e
  }
  ...
  function _(e, t) {
    M(e, "Connecting..."), AdbUtils.getApkPath(e, "com.koushikdutta.vysor", function (n) {
      return n ? void AdbUtils.runMain(e, n, "com.koushikdutta.vysor.ProtocolVersionMain", function (e) {
        ...
        return o && o.length ? (e = o[0], e && (e = e.trim()), console.log("protocol version: " + e), void t("vysor-io-58" != e ? null : n)) : void t(null)
      }) : void t()
    })
  }
  ...
  function x(e, t) {
    function n(n) {
      var o = Math.round(Math.random() * (1 << 30)).toString(16),
        i = "echo -n " + o + " > /data/local/tmp/vysor.pwd ; chmod 600 /data/local/tmp/vysor.pwd";
      AdbUtils.runMain(e, n, "com.koushikdutta.vysor.Main password=" + o + " keyboard=" + Se, function (n) {
        Adb.shell({
          serialno: e,
          command: 'sh -c "' + i + '"'
        }, function (e) {
    ...
    K(e);
    _(e, function (t) {
      return t ? void n(t) : (console.log("uninstalling old apk if exists"), void Adb.shell({
        command: "pm uninstall com.koushikdutta.vysor",
        serialno: e
      }, function (t) {
        console.log("uninstall result", t), console.log("installing apk"), N(e, function (t) {
          _(e, function (o) {
            return o ? void n(o) : (t || (t = ""), m("Error installing APK:\n" + t.trim()), void B(e))
          })
        })
      }))
    })
  ...
  function j(e, t, n) {
    ...
    return i ? (i.show(), t && x(e, function (t) {
      F(i, e, t), i.contentWindow.connectionReady()
      ...
      t.onClosed.addListener(o = function () {
        ...
        return n && n(t), $e[e] ? void x(e, function (n) {
          F(t, e, n), t.contentWindow.connectionReady()
  ...
  function oe(e, t) {
    ...
    console.log(r), _e.listen(i, function (t) {
      ...
      s.onOpenSocket = function (t, n) {
        if ("webstart" == t) return x(e, function (e) {
          a(n, e, function () {
            console.log("sent password", e), n.destroy()
          })
        }), !0
      }
    });
          ...
          $.each(e, function (o, i) {
            ...
            if (!c || s.status != c.status) {
              ...
              var a = s.properties.indexOf("emulator") != -1 || s.properties.indexOf("vbox") != -1,
                d = K(o);
              if (Ge[d] = g(Ge[d], null, 6e4, function () {
                  _(o, function (e) {
                    console.log("Vysor ready to quick launch", o, d), Ge[d].path = e
                  })
                }, !0), !a && Ve && !Xe[d]) {
  ...
  var be = ((new Date).getTime(), "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"),
    ke = "=";
    ...
    if (window.FormData && (e.dataType && "binary" == e.dataType || e.data && (window.ArrayBuffer && e.data instanceof ArrayBuffer || window.Blob && e.data instanceof Blob))) return {
      send: function (t, n) {
        ...
        o.addEventListener("load", function () {
          ...
          n(o.status, o.statusText, null, o.getAllResponseHeaders())
        }), o.open(r, i, s, d, l);
  ...
  ! function () {
    ...
    t.constructor.prototype.async = function () {
      function e() {
        r = i.throw(new Error(arguments)), o()
      }
      ...
      function o(o) {
        var a, d;
        if (r.done) return void s(r.value);
        if (!r.value) return void(r = i.next(n));
        if (r.value.constructor == Promise) return void r.value.then(n).catch(e);
        if (r.value.constructor == t.constructor) {
          var l = r.value.async();
          return void l.then(n).catch(e)
        }
        if (r.value == Error) a = !0, r = i.next(e);
        else {
          if (r.value != y) throw new Error("Unexpected yield value for callback. Only Error and Success allowed.");
          d = !0, r = i.next(n)
        }
        if (!r.value) throw new Error("Double yield callbacks must explicitly define both Error and Success");
        if (r.value == Error && a) throw new Error("Error callback already defined");
        if (r.value == y && d) throw new Error("Success callback already defined");
        if (r.value != Error && r.value != y) throw new Error("Unexpected yield value for callback. Only Error and Success allowed.");
        try {
          r = a ? i.next(n) : i.next(e)
        } catch (e) {
          c(e)
        }
      }
      var i = this,
        r = i.next();
      if (!r.done) {
        var s, c, a = new Promise(function (e, t) {
          s = e, c = t
        });
        return o(), a
      }
    ...
    function () {
      ...
      if (window.IS_RELEASE) {
        ...
        console.error = function () {
          i.apply(console, arguments), e(Array.prototype.slice.call(arguments))
      ...
      e.readers = {}, e.connect = function (t, n) {
        ...
        if (this.pendingWrite)
          if (this.bufferWrites) {
            null != t && console.error("using callbacks in buffered mode?");
            var n = this.pendingWrite;
            this.pendingWrite = function () {
              n && n(), this.write(e, t)
            }.bind(this)
          } else console.error("write is already in progress!");
        if (null == t && (this.bufferWrites || console.error("write callback is null?"), t = function () {}), this.pendingWrite = t, window.chrome && window.chrome.sockets) chrome.sockets.tcp.send(this.socketId, e, function (n) {
    ...
    function () {
      ...
      function d(e) {
        var e = e || {},
          t = e.port || 5037,
          n = e.start !== !1;
        this.currentSocketId = 1, this.pendingDevices = {}, this.port = t, this.adbDevices = {}, this.clients = {}, n && this.start()
      }
      ...
      e.prototype.destroy = function () {
        ...
        switch ("host-serial" == r[0] && (r[0] = "host", i = r.splice(1, 1)[0], Number.isInteger(parseInt(r[1])) && (i += ":" + r.splice(1, 1)[0])), r.length >= 2 && (a = r[0] + ":" + r[1]), a) {
          ...
          case "host:transport-any":
            ...
            this.transport = l,
              this.socket.write(c("OKAY"), function () {});
            break;
          case "host:kill":
            this.server.kill();
            break;
    ...
    function () {
      ...
      t.sendHostCommand = function (e, t) {
        ...
        var o = "reverse:forward:" + e.from + ";" + e.to;
        t.sendClientCommand({
          serialno: e.serialno,
          command: o
        }, function (e, t) {
    ...
    function () {
      ...
      }, e.prototype.sendMessage = AdbDevice.prototype.sendMessage, e.prototype.receiveMessages = AdbDevice.prototype.receiveMessages, e.prototype.onReceiveMessage = AdbDevice.prototype.onReceiveMessage, e.prototype.handleMessage = AdbDevice.prototype.handleMessage, e.prototype.handleUnknown = AdbDevice.prototype.handleUnknown, e.prototype.newSocket = AdbDevice.prototype.newSocket, e.prototype.newAdbSocket = AdbDevice.prototype.newAdbSocket, e.prototype.destroy = AdbDevice.prototype.destroy, e.prototype.onOpenSocket = function (e, t) {
        if (this.openSocket) {
    ...
    function () {
      ...
      S.prototype.refresh = function (e, t) {
        ...
        var f, p, v, g = function (e, t) {
          ...
          E = function* () {
            if (!h) {
              e = "https://billing.vysor.io", i = "Enterprise Account", t = !0, console.log("Cached Enterprise license is valid for " + (Date.now() + 24 * Date.now() * 60 * 60 * 1e3 - Date.now()) / 36e5 + " hours"), o = !0, a(), Date.now() + 24 * Date.now() * 60 * 60 * 1e3 < Date.now() && (v = !1, yield* S())
            }
          }.bind(this);
  ...
  console.log("Vysor version", chrome.runtime.getManifest().version), console.log(navigator.userAgent), console.log("Electron", isElectron()), console.log("Date", new Date);
  ...
  We.globalRefresh = function () {
    ...
    var o = {
      ...
      "/device/(.*?)/audio.adts": function (e, t, n) {
        var o = n[1],
          i = chrome.app.window.get(o);
        ...
        if (!i.contentWindow.siphonAudio) return console.error("siphonAudio", o, "not found"), t.code(404), void t.write("", function () {
          t.end()
        });
        var r = new k;
        if (t.headers.Connection = "close", t.headers["Content-Type"] = "audio/aac", Socket.pump(r, t, function () {
            console.log("aac source closed")
          }), isElectron()) {
          var s = r;
          r = {
